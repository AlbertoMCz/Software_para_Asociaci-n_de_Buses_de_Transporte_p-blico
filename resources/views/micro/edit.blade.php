                                    ...
                                    @method('PUT')
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="nroPlaca" name="nroPlaca" required="required" class="form-control " value="{{$micro->nroPlaca}}">
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="number" id="nroInterno" name="nroInterno" required="required" class="form-control " value="{{$micro->nroInterno}}">
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="marca" name="marca" required="required" class="form-control" value="{{$micro->marca}}">
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="modelo" name="modelo" required="required" class="form-control " value="{{$micro->modelo}}">
											</div>
										</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="descripcion" name="descripcion" required="required" class="form-control " value="{{$micro->descripcion}}">
											</div>
										</div>
